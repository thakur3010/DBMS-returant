        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">Wanna Know Us</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#projects">Dishes</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#signup">Contact Us</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="/DBMSPROJECT/signup.php">Signup</a></li>
                    <span class="badge badge-secondary"><li class="nav-item"><a class="nav-link js-scroll-trigger" href="/DBMSPROJECT/login.php">Login</a></li></span> 
                </ul>
            </div>
        </div>
    </nav>
